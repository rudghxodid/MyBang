    ...
    <v-container>
        <v-stepper v-model="e1">
                <form @submit.prevent="onSubmit">
                    <v-stepper-header>
                    <v-stepper-step :complete="e1 > 1" step="1">중개사무소 정보</v-stepper-step>
                    <v-divider></v-divider>
                    <v-stepper-step :complete="e1 > 2" step="2">매물 입력사항(1)</v-stepper-step>
                    <v-divider></v-divider>
                    <v-stepper-step :complete="e1 > 3" step="3">매물 입력사항(2)</v-stepper-step>
                    <v-divider></v-divider>
                    <v-stepper-step :complete="e1 > 4" step="4">매물 입력사항(3)</v-stepper-step>
                     <v-divider></v-divider>
                    <v-stepper-step step="5">매물 입력사항(4)</v-stepper-step>
                    </v-stepper-header>
                    <v-stepper-items>
                    ...
                    <div class="mt-3">
                        <v-btn class="button_place" color="white" tile large button type="submit">수정완료</v-btn>
...
export default {
    ...
    created () {
        this.address = this.oneroom.address
        this.agentAddress = this.oneroom.agentAddress
        this.agentEmail = this.oneroom.agentEmail
        this.agentLat = this.oneroom.agentLat
        this.agentLng = this.oneroom.agentLng
        this.agentMobile = this.oneroom.agentMobile
        this.agentName = this.oneroom.agentName
        this.agentPhone = this.oneroom.agentPhone
        this.buildingType = this.oneroom.buildingType
        this.deposit = this.oneroom.deposit
        this.description = this.oneroom.description
        this.elevator = this.oneroom.elevator
        this.floor = this.oneroom.floor
        this.floorAll = this.oneroom.floorAll
        this.image = this.oneroom.image
        this.lat = this.oneroom.lat
        this.lng = this.oneroom.lng
        this.local1 = this.oneroom.local1
        this.local2 = this.oneroom.local2
        this.local3 = this.oneroom.local3
        this.manageCost = this.oneroom.manageCost
        this.manageCostInc = this.oneroom.manageCostInc
        this.moveinDate = this.oneroom.moveinDate
        this.nearSubways = this.oneroom.nearSubways
        this.options = this.oneroom.options
        this.parking = this.oneroom.parking
        this.pets = this.oneroom.pets
        this.roomDirection = this.oneroom.roomDirection
        this.roomType = this.oneroom.roomType
        this.salesType = this.oneroom.salesType
        this.serviceType = this.oneroom.serviceType
        this.size = this.oneroom.size
        this.sizeM2 = this.oneroom.sizeM2
        this.title = this.oneroom.title
        this.updatedAt = this.oneroom.updatedAt
        this.userIntro = this.oneroom.userIntro
        this.userName = this.oneroom.userName
        this.url = this.oneroom.url
        this.agentId = this.oneroom.agentId
        this.rent = this.oneroom.rent
    },
}
</script>
